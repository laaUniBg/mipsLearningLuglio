...
.eqv OFFSET_EXAM_GRADE              4 # SIZE_INT        + OFFSET_EXAM_CREDITS 
.eqv OFFSET_EXAM_NAME               8 # SIZE_INT        + OFFSET_EXAM_GRADE
.eqv SIZE_EXAM_STRUCT               28 # SIZE_STRING     + OFFSET_EXAM_NAME
...
.data
    studentStructOffsets: .word 0, 4, 8, 
